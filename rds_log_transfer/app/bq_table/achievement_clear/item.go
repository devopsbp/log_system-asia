...
type AchievementClearItem struct {
	UserId                *string               `json:"user_id,omitempty"`
	CharacterId           *string               `json:"character_id,omitempty"`
	CharacterName         *string               `json:"character_name,omitempty"`
	AchievementId         *json.Number          `json:"achievement_id,omitempty"`
	AchievementIdName     *string               `json:"achievement_id__name,omitempty"`
...
func (i AchievementClearItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		...
		"achievement_id__name":    i.AchievementIdName,
