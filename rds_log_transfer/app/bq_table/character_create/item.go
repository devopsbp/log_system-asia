...
type CharacterCreateItem struct {
	UserId                *string               `json:"user_id,omitempty"`
	CharacterId           *string               `json:"character_id,omitempty"`
	CharacterName         *string               `json:"character_name,omitempty"`
	CreateParam           *interface{}          `json:"create_param,omitempty"`
...
func (i CharacterCreateItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		"user_id":                 i.Record.UserId,
		"character_id":            i.Record.CharacterId,
		"character_name":          i.CharacterName,
		"create_param":            sb_log.EncodeJsonValue(i.CreateParam),
