...
var boolKeys = []string{"accepttype"}

type GuildCreateItem struct {
	...
	Accepttype            *bool                 `json:"accepttype,omitempty"`
...
func (i GuildCreateItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		...
		"guild_tag":               i.GuildTag,
		"comment":                 i.Comment,
		"times":                   sb_log.EncodeJsonValue(i.Times),
		"styles":                  sb_log.EncodeJsonValue(i.Styles),
