package get_season_pass_reward
...
type GetSeasonPassRewardItem struct {
	...
	SeasonRewardId        *string               `json:"season_reward_id,omitempty"`
...
func (i GetSeasonPassRewardItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		...
		"season_reward_id":        i.SeasonRewardId,
		"mail_id":                 i.MailId,
