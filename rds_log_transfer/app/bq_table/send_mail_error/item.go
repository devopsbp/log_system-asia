...
type SendMailErrorItem struct {
	UserId                *string               `json:"user_id,omitempty"`
	CharacterId           *string               `json:"character_id,omitempty"`
	SbRetCode             *json.Number          `json:"sb_ret_code,omitempty"`
	SbErrorMessage        *string               `json:"sb_error_message,omitempty"`
...
func (i SendMailErrorItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		"user_id":                 i.Record.UserId,
		"character_id":            i.Record.CharacterId,
		"sb_ret_code":             i.SbRetCode,
		"sb_error_message":        i.SbErrorMessage,
