...
type GuildChangeNameItem struct {
	UserId                *string               `json:"user_id,omitempty"`
	CharacterId           *string               `json:"character_id,omitempty"`
	CharacterName         *string               `json:"character_name,omitempty"`
	GuildId               *string               `json:"guild_id,omitempty"`
	OldGuildName          *string               `json:"old_guild_name,omitempty"`
	OldGuildTag           *string               `json:"old_guild_tag,omitempty"`
	NewGuildName          *string               `json:"new_guild_name,omitempty"`
	NewGuildTag           *string               `json:"new_guild_tag,omitempty"`
...
func (i GuildChangeNameItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		"user_id":                 i.Record.UserId,
		"character_id":            i.Record.CharacterId,
		"character_name":          i.CharacterName,
		"guild_id":                i.GuildId,
		"old_guild_name":          i.OldGuildName,
		"old_guild_tag":           i.OldGuildTag,
		"new_guild_name":          i.NewGuildName,
		"new_guild_tag":           i.NewGuildTag,
