...
type QuestCompleteItem struct {
	...
	ClearCount             *json.Number          `json:"clear_count,omitempty"`
...
func (i QuestCompleteItem) Save() (map[string]bigquery.Value, string, error) {
