...
type StampAcquisitionItem struct {
	UserId                *string               `json:"user_id,omitempty"`
	CharacterId           *string               `json:"character_id,omitempty"`
	CharacterLevel        *json.Number          `json:"character_level,omitempty"`
	StampIds              *interface{}          `json:"stamp_ids,omitempty"`
...
func (i StampAcquisitionItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		"user_id":                 i.Record.UserId,
		"character_id":            i.Record.CharacterId,
		"character_level":         i.CharacterLevel,
		"stamp_ids":               sb_log.EncodeJsonValue(i.StampIds),
