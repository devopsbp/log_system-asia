...
var boolKeys = []string{"is_network_cafe"}
...
type LogoutItem struct {
	...
	IsNetworkCafe         *bool                 `json:"is_network_cafe,omitempty"`
	ClientExitStatus      *json.Number          `json:"client_exit_status,omitempty"`
...
func (i LogoutItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		...
		"ip":                      i.Ip,
		"is_network_cafe":         i.IsNetworkCafe,
		"client_exit_status":      i.ClientExitStatus,
