...
type CharacterSellItemItem struct {
	...
	Money                 *json.Number          `json:"money,omitempty"`
	NowMoney              *json.Number          `json:"now_money,omitempty"`
...
func (i CharacterSellItemItem) Save() (map[string]bigquery.Value, string, error) {
