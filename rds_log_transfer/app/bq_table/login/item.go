...
var boolKeys = []string{"is_network_cafe", "is_first_login"}
...
func (i LoginItem) Save() (map[string]bigquery.Value, string, error) {
	return map[string]bigquery.Value{
		"user_id":                 i.Record.UserId,
		"ip":                      i.Ip,
		"platform":                i.Platform,
		"is_network_cafe":         i.IsNetworkCafe,
		"is_first_login":          i.IsFirstLogin,
